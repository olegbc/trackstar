...
class m150130_232845_create_issue_user_and_assignment_tables extends CDbMigration
{
    public function safeUp()
    {
        ...
        //foreign key relationships the tbl_issue.project_id is a reference to tbl_project.id
